...
void test_esp_plugin_new() {
  ...
  Plugin * plugin;
  auto return_code = esp_plugin_new(&plugin, ESPM_GAME_SKYRIM, "foo");
...
void test_esp_plugin_parse() {
  ...
  Plugin * plugin;
  auto return_code = esp_plugin_new(&plugin, ESPM_GAME_SKYRIM, "../../testing-plugins/Skyrim/Data/Blank.esm");
  assert(return_code == ESPM_OK);
...
void test_esp_plugin_masters() {
  ...
  Plugin * plugin;
  auto return_code = esp_plugin_new(&plugin, ESPM_GAME_SKYRIM, "../../testing-plugins/Skyrim/Data/Blank - Master Dependent.esm");
  assert(return_code == ESPM_OK);
...
void test_esp_plugin_is_light_master() {
  ...
  Plugin * plugin;
  auto return_code = esp_plugin_new(&plugin, ESPM_GAME_FALLOUT4, "../../testing-plugins/Skyrim/Data/Blank.esl");
  assert(return_code == ESPM_OK);
...
void test_esp_plugin_is_valid() {
  bool is_valid;
  auto return_code = esp_plugin_is_valid(ESPM_GAME_SKYRIM, "../../testing-plugins/Skyrim/Data/Blank.esm", true, &is_valid);
  assert(return_code == ESPM_OK);
  assert(is_valid);
}
