...
mod tests {
    ...
    fn decompress_data_should_read_a_compressed_subrecord_correctly() {
        const DATA: &'static [u8] = &[
            0x42, 0x50, 0x54, 0x4E, 0x1D, 0x00, 0x19, 0x00, 0x00, 0x00, 0x75, 0xc5, 0x21, 0x0d,
            0x00, 0x00, 0x08, 0x05, 0xd1, 0x6c, 0x6c, 0xdc, 0x57, 0x48, 0x3c, 0xfd, 0x5b, 0x5c,
            0x02, 0xd4, 0x6b, 0x32, 0xb5, 0xdc, 0xa3,
        ];
    ...
    fn decompress_data_should_error_if_the_compressed_data_is_invalid() {
        const DATA: &'static [u8] = &[
            0x42, 0x50, 0x54, 0x4E, 0x1D, 0x00, 0x19, 0x00, 0x00, 0x00, 0x75, 0xc5, 0x21, 0x0d,
            0x00, 0x00, 0xA8, 0x05, 0xd1, 0x6c, 0x6c, 0xdc, 0x57, 0x48, 0x3c, 0xfd, 0x5b, 0x5c,
            0x02, 0xd4, 0x6b, 0x32, 0xb5, 0xdc, 0xa3,
        ];
